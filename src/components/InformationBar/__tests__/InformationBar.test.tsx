...
describe("Tests for InformationBar Component", () => {
  ...
  test("ID: F.IB.1 - InformationBar component renders correctly with title and elements", () => {
  ...
  test("ID: F.IB.2 - Title displays correctly with unique text", () => {
  ...
  test("ID: F.IB.3 - Applies correct styling and classes to the bar", () => {
    render(<InformationBar title="Test Title" elements={elementsMock} />);
    const bar = screen.getByTestId("information-bar");
