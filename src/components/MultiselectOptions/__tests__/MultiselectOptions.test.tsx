...
describe("Tests for MultiselectOptions Component", () => {
    ...
    test("ID: F.MSO.1 - Renders without check icon when isSelected is false", () => {
    ...
    test("ID: F.MSO.2 - Renders with check icon when isSelected is true", () => {
    ...
    test("ID: F.MSO.3 - Calls onChange when the checkbox is clicked", () => {
        render(<MultiselectOptions label={mockLabel} isSelected={false} onChange={mockOnChange} />);
